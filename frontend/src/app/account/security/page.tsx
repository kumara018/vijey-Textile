 ...
 * Sign-in & security.
 *
 * This file WAS the account page, carrying details, addresses, a password form
 * and a device list on one scroll. Opening your account to check an order and
 * being shown "Current password / New password / Confirm new password" is a
 * page answering a question nobody asked, and it was said plainly. Amazon —
 * named as the standard — keeps Your Account as a grid of destinations and
 * Login & security on its own page. That is the correct shape.
 *
 * So the destinations moved to /account, the addresses moved to
 * /account/addresses, and what stayed here is the four things that decide who
 * can act as you. Nothing about the behaviour changed — the error states, the
 * focus management and the announcements below are the original work and the
 * reason this page was split rather than rewritten.
 *
 *
  ...
  return (
    <PageShell rhythm="tight">
      <PageHeader
        ...
        standfirst="Who you are to us, and who can sign in as you."
      />
...
export default function SecurityPage() {
  return (
    <RouteErrorBoundary routeName="sign-in and security" fallbackHref="/account" fallbackLabel="Back to your account">
      <AccountInner />
    </RouteErrorBoundary>
  );
}
