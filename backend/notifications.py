...
#   bg-brand-gradient = linear-gradient(135deg, #be185d 0%, #9f1239 100%)
...
<body style="margin:0;padding:24px 16px;background:#fff0f6;font-family:Arial,Helvetica,sans-serif;">
...
def send_welcome_email(email: str, name: str):
    ...
    html = _wrap(f"""
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0;">
        <tr>
          <td style="padding:12px 8px;text-align:center;background:#fff0f6;border-radius:8px;width:30%;">
...
_STATUS_MAP = {
    ...
    "shipped":          ("📦 Your Order is Shipped!",   "#be185d", "#fff0f6", "Your order is on its way — expect it soon!"),
...
def send_login_otp_email(email: str, name: str, otp: str):
    ...
    html = _wrap(f"""
      ...
      <div style="background:#fff0f6;border:2px solid #be185d;border-radius:12px;padding:28px;margin:24px 0;text-align:center;">
...
def send_cart_add_email(email: str, name: str, product_name: str,
    ...
    html = _wrap(f"""
      ...
      <div style="background:#fff0f6;border:2px solid #f97316;border-radius:12px;padding:20px;margin:20px 0;display:flex;align-items:center;gap:16px;">
...
def send_support_rating_confirmation(email: str, name: str, rating: int):
    ...
    html = _wrap(f"""
      ...
      <div style="background:#fff0f6;border:2px solid #be185d;border-radius:12px;padding:24px;margin:20px 0;text-align:center;">
...
_RETURN_STATUS_INFO = {
    ...
    "pickup_scheduled":     ("Pickup Scheduled",            "#be185d", "Our courier will pick up the item from your address."),
    ...
    "replacement_shipped":  ("Replacement Shipped",         "#be185d", "Your replacement item is on its way!"),
      ...
      <div style="padding:28px 32px">
        ...
        <div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:8px;padding:14px 16px;margin-bottom:20px">
          ...
          <table width="100%" style="border-collapse:collapse;font-size:13px">
            ...
            <tr><td style="color:#555;padding:3px 0">Status</td><td style="text-align:right;font-weight:bold;color:{'#16a34a' if order.payment_status == 'paid' else '#d97706' if order.payment_status == 'pending' else '#be185d'}">{order.payment_status.upper()}</td></tr>
...
def send_admin_access_email(email: str, name: str):
    ...
    html = _wrap(f"""
      ...
      <!-- What you can do -->
      <div style="background:#fff0f6;border-radius:12px;padding:20px 24px;margin:20px 0;">
